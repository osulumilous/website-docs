...
old_id: 12
---
If you're having troubles connecting to osu!lumilous or the switcher doesn't install the certificate properly, you can try installing it manually.
...
- Wait a few seconds and all the labels in the "Server connection" section, on the right, should become green and report "OK" (like [this](https://i.ibb.co/68TL6zT/Settings-Form.png)). If so, you should be able to connect to osu!lumilous.  
- If you get **CERT ERROR**, the certificate has not been installed successfully. **Follow the instructions below.**  
- If you get **"..."**, you're not connected to o!lumilous. Close the inspect window, click on **Switch to osu!lumilous** and try again.  
...
- Click on **Test connection** and you should see "OK" for every domains  
**If the inspect dialog is fine but you still can't connect to o!lumilous from the game client, try running osu! as administrator**.
