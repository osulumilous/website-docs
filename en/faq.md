...
- **I get "Connection failed" when I try to connect to o!lumilous**  
- Click the "Inspect" button on the server switcher and make sure that all the labels are green ([like this](https://i.ibb.co/68TL6zT/Settings-Form.png)). If you still can't solve this problem, come on our [Discord](https://discord.gg/eBqCYT8) and we'll help you.

-----------------------

- **I get "Bancho authentication failed" (wrong password) when I try to log in, but my password is correct!**  
- First, make sure you're connected to o!lumilous (the server switcher should report "You're playing on osu!lumilous") and that your password is corrected. If so, type your username and password, then press the **login** button with your mouse. I know, it's weird but it often works. *(make also sure that caps lock is disabled if your password is lowercase)*
...
- **My switcher is off but when I open osu.ppy.sh in my browser I get an error or I get redirected to o!lumilous's website!**
...
- **I get strange errors on osu!'s website after playing on o!lumilous (beatmaps not found etc)**
...
- **Is there a patcher for o!lumilous?**
- No, you can change server by editing the hosts file with our switcher. [Instructions here](https://osu.lumilous.pw/doc/1).

-----------------------

- **Can I have o!lumilous's source code?**
-  o!lumilous is mostly open source, you can see it [here](https://github.com/osulumilous).

-----------------------

- **Why are osu!direct and other in-game supporter perks free?**
- We think that osu! direct is very cool and it's a shame people have to pay to have it, that's why we're offering it for free on o!lumilous. If you like what we do, please consider a [donation](/donate)

-----------------------

- **My problem is not listed here**
- Join our [discord](https://discord.gg/eBqCYT8) and ask your question in the #help channel of the server.